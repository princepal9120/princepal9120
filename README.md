...
A curated list of my top AI and Full Stack projects showcasing end-to-end development, modern tech stacks, and real-world impact.
...
- **Features**: Function-calling, context-aware LLM responses

🔗 [Live Demo](https://prince-personalized-chatbot.vercel.app)  
📦 [GitHub Repo](https://github.com/princepal9120/PersonalizedChatbot)

---

## 🌿 EcoQuest
AI-powered waste reporting platform that leverages image recognition and location tracking to reduce response time by 30%.
- **Stack**: Next.js, Drizzle ORM, PostgreSQL, Gemini Vision API, Google Maps API
- **Features**: Geolocation reports, Admin dashboard, Image-based classification

🔗 [Live Demo](https://ecoquest-topaz.vercel.app/)  
📦 [GitHub Repo](https://github.com/prncepal9120/ecoquest)

---

## 📚 Learnify
A scalable Learning Management System (LMS) with robust admin and student dashboards supporting 500+ users.
- **Stack**: React.js, Express.js, MongoDB, Node.js, React Query
- **Features**: Course creation, user management, authentication

🔗 [Live Demo](https://learnifywithai.onrender.com)  
📦 [GitHub Repo](https://github.com/princepal9120/Learnify)

---

## 💼 JobConnect Portal
Full-stack job portal enabling candidates and recruiters to post, search, and apply with real-time analytics.
- **Stack**: MERN (MongoDB, Express, React, Node.js), Redux, JWT Auth
- **Features**: Role-based dashboards, secure login, analytics

🔗 [Live Demo](https://talentbridge-1yxp.onrender.com/)  
📦 [GitHub Repo](https://github.com/princepal9120/TalentBridge)

---

## ✨ EmailGenie
Generates personalized outreach emails using LangChain and Gmail API based on simple user prompts.
- **Stack**: Next.js, LangChain, TypeScript, Gmail API
- **Features**: AI-generated content, email integration
